...
////// Lighting:
////// Emissive:
                float4 node_2902 = _Time + _TimeEditor;
                float2 node_1822 = (i.uv0+node_2902.g*float2(0,0.1));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_1822, _MainTex));
